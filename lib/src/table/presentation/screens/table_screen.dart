                            ...
                            data: (data) {
                              return RefreshIndicator.adaptive(
                                onRefresh: () => ref.refresh(
                                  tableControllerProvider.future,
                                ),
                                child: ListView(
                                                              ...
                                                              Column(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    e.mergedAvailable !=
                                                                                null &&
                                                                            e.mergedAvailable!.isNotEmpty
                                                                        ? 'Meja ${e.noTable} bisa digabung dengan ${e.mergedAvailable!.map((id) {
                                                                              final table = data.where((table) => table.id == id).toList();
                                                                              return table.isNotEmpty ? 'meja ${table.first.noTable}' : null;
                                                                            }).where((noTable) => noTable != null).join(', ')}*'
                                                                        : 'Meja ini tidak dapat digabung',
                                                                    style:
                                                                        TextStyle(
